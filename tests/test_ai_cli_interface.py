...
def test_language_config():
    ...
    expected_keys = ["security_tools", "test_command", "lint_command", "build_command", "security_scan"]
...
def test_cost_estimation_complex():
    ...
    if simple_estimate and estimate['estimated_total_cost'] > simple_estimate['estimated_total_cost']:
...
def test_cost_estimation_different_languages():
    ...
    for lang in languages:
        ...
        if estimate:
            ...
            print(f"✅ {lang.title()} estimate: ${estimate['estimated_total_cost']:.4f}")
        else:
...
def test_error_handling():
    ...
    estimate = ai_cli.estimate_task_cost("", "python")
    ...
    estimate = ai_cli.estimate_task_cost(long_task, "python")
