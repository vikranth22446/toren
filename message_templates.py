...
"""
    ...
    @staticmethod
    def format_task_completed(reviewer: str, pr_number: str, branch: str, 
                            lines_changed: int, cost_info: Optional[Dict[str, Any]] = None) -> str:
    ...
    @staticmethod
    def format_validation_failed(reviewer: str, issues: list, branch: str, lines_changed: int) -> str:
    ...
    @staticmethod
    def completion_notification(reviewer: str, summary: str, cost_info: str = "") -> str:
    ...
    def commit_message(task_summary: str) -> str:
        ...
        return MessageTemplates.COMMIT_MESSAGE.format(
            task_summary_short=task_summary_short,
            task_summary=task_summary
        )

    @staticmethod
    def pr_body(summary: str, reviewer: str, cost_info: str = "", issue_ref: str = "") -> str:
        """Format PR body"""
    ...
    @staticmethod
    def pr_task_header(pr_number: str, title: str, state: str, branch: str, description: str) -> str:
