...
def test_notifications():
    ...
    if not confirm(f"Check issue #{TEST_ISSUE_NUMBER} - did progress notification appear?"):
        return False
    ...
    return confirm(f"Check issue #{TEST_ISSUE_NUMBER} - did completion notification appear?")
