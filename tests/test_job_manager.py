...
def test_job_status_updates():
    ...
    try:
        ...
        success = jm.update_job_status(
            job_id, "completed", pr_url="https://github.com/user/repo/pull/456"
        )
        assert success
...
def test_data_validation():
    ...
    try:
        ...
        assert jm._validate_job_data(valid_data)
        ...
        assert jm._validate_job_data(invalid_data) is False
        ...
        assert jm._validate_job_data(invalid_status_data) is False
        ...
        assert jm._validate_job_data(invalid_type_data) is False
