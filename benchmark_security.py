...
def simulate_bandit_scan(files_to_scan=None):
    ...
    if files_to_scan is None:
        files_to_scan = ['claude_agent.py', 'github_utils.py', 'job_manager.py']
...
def main():
    ...
    scenarios = [
        ("Small change (1 file)", ["claude_agent.py"]),
        ("Medium change (2 files)", ["claude_agent.py", "github_utils.py"]),
        ("Large change (3 files)", ["claude_agent.py", "github_utils.py", "job_manager.py"]),
    ]
